...
// Sécurité : vérifie que l'utilisateur est un admin
// Assurez-vous que 'is_admin_fixed' est correctement défini lors de la connexion de l'admin.
if (!isset($_SESSION['is_admin_fixed']) || $_SESSION['is_admin_fixed'] !== true) {
    header("Location: connexion.php"); // Rediriger si non admin
    exit();
}
